# -*- coding: utf-8 -*-
"""
GOREV veri motoru v1.2 (2026-07-10)
...
def fetch_jsearch():
    ...
    for lane, cfg in CONFIG["lanes"].items():
        ...
        try:
            ...
            errors.append(f"jsearch [{q}]: {type(e).__name__}")
    return jobs, errors
...
def fetch_remotive():
    ...
    for lane, cfg in CONFIG["lanes"].items():
        ...
        try:
            ...
            errors.append(f"remotive [{q}]: {type(e).__name__}")
    return jobs, errors
...
def fetch_arbeitnow():
    ...
    try:
        ...
        errors.append(f"arbeitnow: {type(e).__name__}")
    return jobs, errors
...
def main():
    ...
    for fn in (fetch_jsearch, fetch_hiring_cafe, fetch_remotive,
